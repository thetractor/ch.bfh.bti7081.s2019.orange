...
public class PatientDetail extends ViewFrame implements HasUrlParameter<String> {
  ...
  protected void onAttach(AttachEvent attachEvent) {
    ...
    appBar.setTitle(patient.getName());
    UI.getCurrent().getPage().setTitle(patient.getName());
  }
